...
<html lang="en" oncontextmenu="return false">
  <head>
	...
	<link rel="stylesheet" href="assets/css/colirification.css">
...
<style> img[src="https://cdn.000webhost.com/000webhost/logo/footer-powered-by-000webhost-white2.png"] { display: none; }</style>
  <body class="header-fixed">
                    ...
                    <form>
                      <div class="form-row">
                        <div class="form-group col-md-12">
							<img class="profile-img img-lg" align="right" src="assets/images/logo.jpg" alt="profile image">
								<div class="w3-container">
									<h4>Complete Transaction (STEP 2)</h4>
									<h6 class="text-gray">Kindly Provide a reason for this transfer before completing this transaction</h6>
									<textarea class="form-control input-default" name="message" cols="30" placeholder="e.g. feeding allawance"></textarea>
									<br>
									<h6 class="text-gray">Transfer</h6>
									<div class="w3-light-grey">
										<div id="myBar" class="w3-container w3-green" style="height:24px;width:0%"></div>
									</div>
									<br>
									<p id="myP">Transaction in Progress <span id="demo">0</span>%</p>
									<br><button class="w3-button w3-light-grey shadow" onclick="move();this.disabled='true'">Send Funds</button> 
								</div>
                        </div>
                      </div> 
                    </form>
    ...
    <script src="assets/js/skillidationeight.js"></script>
	<script src="assets/js/ceratopaplonia.js"></script>
